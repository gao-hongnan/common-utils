...
class BatchState(Serializable):
    batch_index: int = -1
    avg_train_loss_per_sample_this_batch: float = -1.0
    avg_valid_loss_per_sample_this_batch: float = -1.0
...
class EpochState(Serializable):
    ...
    avg_valid_loss_per_sample_this_epoch: float = -1.0
...
class State(Serializable):
    batch_states: Dict[int, List[BatchState]] = None
    epoch_states: Dict[int, EpochState] = None
